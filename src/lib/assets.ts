/**
 * Helper constants for public assets
...
export const ASSETS = {
  ...
  logoVideo: `${import.meta.env.BASE_URL}assets/logo_pulsing.mp4`,
  snippetsVideo: `${import.meta.env.BASE_URL}assets/video_quick_snippets.mp4`,
};
